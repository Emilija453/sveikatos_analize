...
skandinavijos_saliu_indekso_df.rename(columns={'value_x_x': '1980-1985', 'value_y_x': '1990-1995',
...
baltijos_saliu_indekso_df = pd.merge(balt1, balt2, on='country')
baltijos_saliu_indekso_df.rename(columns={'value_x_x': '1980-1985', 'value_y_x': '1990-1995',
                                                'value_x_y': '2000-2005', 'value_y_y': '2010-2013'}, inplace=True)
